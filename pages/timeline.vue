		...
		<view class="cu-timeline" v-if="show == 1">
			...
			<view class="cu-item text-blue">
				<view class="content">
					...
					<view class="margin-top">测试</view>
				</view>
			</view>
			<view class="cu-time">
				<text class='cuIcon-selection text-white text-lg bg-blue round padding-xs'></text>
				<text class='text-xl margin-left'>测试</text>
			</view>
			<view class="cu-item text-blue">
				<view class="content">
					<view class="cu-capsule radius">
						<view class="cu-tag bg-blue">制作</view>
						<view class="cu-tag line-blue">测试</view>
					</view>
					<view class="margin-top">测试</view>
				</view>
			</view>
				...
				<swiper-item class="swiper-item">
					<scroll-view scroll-y style="height: 100%;width: 100%;">
						...
						<view class="cu-timeline">
							<view class="cu-time">
								<text class='cuIcon-selection text-white text-lg bg-blue round padding-xs'></text>
								<text class='text-xl margin-left'>解决方案+项目</text>
							</view>
							<view class="cu-item text-blue">
								<view class="content">
									<view class="cu-capsule radius">
